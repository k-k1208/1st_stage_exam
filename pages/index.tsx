  ...
  return (
          ...
          <nav>
            <div className="flex">
              ...
              <ul className="ml-auto  w-1/4 flex justify-between  items-center space-x-4 mr-10">
                  <li className="text-lg hover:underline"><Link href="/#ABOUT"><a>ABOUT</a></Link></li>
                  <li className="text-lg hover:underline"><Link href="/#SKILLS"><a>SKILLS</a></Link></li>
                  <li className="text-lg hover:underline"><Link href="/#VALUES"><a>VALUES</a></Link></li>
                  <li className="text-lg hover:underline"><Link href="/#FUTURE"><a>FUTURE</a></Link></li>
              </ul>
            </div>
          </nav>
      </header>
    ...
    <section className="pt-20 w-full h-[570px] relative mb-10 bg-[#6bc2c3]">
        <div className="flex w-full h-full">
            <div className="w-1/3 absolute top-2/4">
                <h1 className="text-3xl text-center">メインタイトル</h1>
                <h2 className="text-2xl text-center">サブタイトル</h2>
            </div>
    ...
    <div id="valuesFutureZindex" className="relative z-0">
      <section id="ABOUT" className="pt-20 -mt-20 pb-10 bg-[url('/bg-about.png')]  w-full h-[570px] border-2 border-solid border-yellow-900 ">
        <h2 className="text-2xl text-center border-2 border-solid border-yellow-900 mb-10">私たちについて <span className="text-lg">ABOUT</span></h2>
        ...
        <div className="flex justify-center  space-x-14 mb-20 relative z-40">
            <div id="hobby" className="w-1/5 border-2 border-solid border-yellow-900">
                ...
                <h3 className="text-center">趣味</h3>
                <p>
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
            ...
            <div id="favoriteFood" className="w-1/5 border-2 border-solid border-yellow-900">
                ...
                <h3 className="text-center">好きな食べ物</h3>
                <p>
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
            ...
            <div id="personality" className="w-1/5 border-2 border-solid border-yellow-900">
                ...
                <h3 className="text-center">性格</h3>
                <p>
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
                    テキストテキストテキストテキスト
      ...
      <section id="SKILLS" className="w-full h-[570px] pt-20 -mt-20 mb-10 pb-28 border-2 border-solid border-black bg-transparent bg-[url('/bg-skills.png')] bg-no-repeat bg-[length:100%_100%] z-30">
          <div className="flex w-full h-full border-2 border-solid border-pink-800">
              ...
              <div className="ml-10 border-2 border-solid border-gray w-2/4 mr-20">
                  <h2 className="text-2xl w-auto">スキル<span className="text-lg">SKILLS</span></h2>
                  <p className="w-2/3 ">
                      テキストテキストテキストテキスト
                      テキストテキストテキストテキスト
                      テキストテキストテキストテキスト
      ...
      <section id="VALUES" className="w-full h-[570px] pt-20 -mt-20 pb-10">
          <h2 className="text-2xl text-center">価値観 <span className="text-lg">VALUES</span></h2>
          ...
          <div className="flex justify-center h-full">
              <div className="space-x-14 inline-flex w-4/6 h-auto justify-center  bg-white  border-2 border-solid  border-black rounded-lg relative z-20">
                  <article className="w-1/4 border-2 border-solid border-gray">
                      ...
                      <h3 className="text-center mb-8">価値観01</h3>
                      <p>
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
                  ...
                  <article className="w-1/4 border-2 border-solid border-gray">
                      ...
                      <h3 className="text-center mb-8">価値観02</h3>
                      <p>
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
                  ...
                  <article className="w-1/4 border-2 border-solid border-gray">
                      ...
                      <h3 className="text-center mb-8">価値観03</h3>
                      <p>
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
                          テキストテキストテキストテキスト
      ...
      <section className="z-10 h-[570px] w-full  relative flex space-x-8 justify-center items-center pt-40 -mt-32 bg-[url('/bg-future.png')] bg-[length:100%_100%] pb-10">
          <div className=" border-2 border-solid border-gray w-1/3 relative">
              <h2 id="FUTURE" className=" pt-20 -mt-20 text-2xl border-2 border-solid border-gray">3年後にやりたいこと<span className="text-lg">FUTURE</span></h2>
              <p className="border-2 border-solid border-gray">
                  テキストテキストテキストテキスト
                  テキストテキストテキストテキスト
                  テキストテキストテキストテキスト
                  テキストテキストテキストテキスト
